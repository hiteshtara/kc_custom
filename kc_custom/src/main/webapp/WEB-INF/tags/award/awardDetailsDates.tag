...
<c:set var="awardExtenstionAttributes" value="${DataDictionary.AwardExtension.attributes}" />
...
<table cellpAdding="0" cellspacing="0" summary="">
    ...
    <th>
        <div align="right">
            <kul:htmlAttributeLabel attributeEntry="${awardExtenstionAttributes.customField1}" />
        </div>
    </th>
    <td align="left" valign="middle">
        <kul:htmlControlAttribute property="document.awardList[0].extension.customField1" attributeEntry="${awardExtenstionAttributes.customField1}" />
    </td>
    <th>
        <div align="right"><kul:htmlAttributeLabel attributeEntry="${awardExtenstionAttributes.customField2}" /></div>
    </th>
    <td align="left" valign="middle">
        <kul:htmlControlAttribute property="document.awardList[0].extension.customField2" attributeEntry="${awardExtenstionAttributes.customField2}" />
    </td>
    <td align ="left" valign ="middle">
    <html:image property="methodToCall.trainingRefresh" src="${ConfigurationProperties.kra.externalizable.images.url}tinybutton-refresh.gif" styleClass ="tinybuttton" />
    </td>
</tr>
